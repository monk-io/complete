...
func predictLocalAndSystem(prefix string) []string {
	...
	// System directories are not actual file names, for example: 'github.com/monk-io/complete' could
	// be the argument, but the actual filename is in $GOPATH/src/github.com/monk-io/complete'. this
